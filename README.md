...
# Tip: increasing threads significantly speeds up large CIDR scans (e.g. -thread 50)
./RealiTLScanner -addr wiki.ubuntu.com -thread 10

# Set a timeout for each scan, default: 10 (seconds)
# Tip: lowering timeout to 5s is usually safe and speeds up scanning considerably
